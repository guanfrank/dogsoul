...
$includePathNode = ($xml.cproject.storageModule.cconfiguration.storageModule.configuration.folderInfo.toolChain.tool.option | where {$_.valueType -eq "includePath"})
if ($includePathNode) {
...
$symbolsNode = ($xml.cproject.storageModule.cconfiguration.storageModule.configuration.folderInfo.toolChain.tool.option | where {$_.valueType -eq "definedSymbols"})
if ($symbolsNode) {
...
########################## LIBARIES ############################
  ...
  # Select libs node
  $libsNode = ($xml.cproject.storageModule.cconfiguration.storageModule.configuration.folderInfo.toolChain.tool.option | where {$_.valueType -like "libs"})
  ...
  $libPathNode = ($xml.cproject.storageModule.cconfiguration.storageModule.configuration.folderInfo.toolChain.tool.option | where {$_.valueType -like "libPaths"})
